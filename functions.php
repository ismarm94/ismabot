...
//Funciones de respuesta del bot
     ...
     //buscamos que exista el usuario dentro de la base de datos
            ...
            $result = $conn->query($sql);
             ...
             echo "Error updating record: " . $conn->error;
                ...
                //si el usuario no existe, se le añade a la tabla y se le añaden fichas, despues se le quitan las fichas apostadas
 ...
 function sendIMG($chatId, $img) {
    ...
    //$arrimages = array("https://proyectoismabot.000webhostapp.com/multimedia/coche.jpg", "https://proyectoismabot.000webhostapp.com/multimedia/paisaje.jpg", "https://proyectoismabot.000webhostapp.com/multimedia/parque.png");
    
    //$img = arrimages[1];
    
    //$img = array_slice($arrimages, $numberRand);
